...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0xaba91632 (decimal -1414982094)
	set	_packageName,r2
	set	0xaba91632,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_onemutex
	set	_Global_onemutex,r1
	store	r1,[r14+-220]
!   Send message Init
	load	[r14+-220],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_MutexLock1
	set	_Global_MutexLock1,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_316 = &_Global_bempty
	set	_Global_bempty,r1
	store	r1,[r14+-212]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_317 = &_Global_bfull
	set	_Global_bfull,r1
	store	r1,[r14+-208]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_432 = &_Global_buffer
	set	_Global_buffer,r1
	store	r1,[r14+-40]
!   Move address of _temp_432 [_Global_bufferNextIn ] into _temp_433
!     make sure index expr is >= 0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: *_temp_433 = c  (sizeInBytes=1)
	loadb	[r14+-9],r1
	load	[r14+-36],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   _temp_434 = _Global_bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-32]
!   _Global_bufferNextIn = _temp_434 rem 5		(int)
	load	[r14+-32],r1
	mov	5,r2
	cmp	r2,0
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_4	! 16:	Checking
